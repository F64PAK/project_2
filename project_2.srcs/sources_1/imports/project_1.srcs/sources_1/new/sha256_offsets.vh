...
parameter SPX_OFFSET_LAYER = 0;  /* The byte used to specify the Merkle tree layer */
parameter SPX_OFFSET_TREE = 1;   /* The start of the 8 byte field used to specify the tree */
parameter SPX_OFFSET_TYPE = 9;   /* The byte used to specify the hash type (reason) */
parameter SPX_OFFSET_KP_ADDR2 = 12;  /* The high byte used to specify the key pair (which one-time signature) */
parameter SPX_OFFSET_KP_ADDR1 = 13;  /* The low byte used to specify the key pair */
parameter SPX_OFFSET_CHAIN_ADDR = 17;  /* The byte used to specify the chain address (which Winternitz chain) */
parameter SPX_OFFSET_HASH_ADDR = 21;  /* The byte used to specify the hash address (where in the Winternitz chain) */
parameter SPX_OFFSET_TREE_HGT = 17;  /* The byte used to specify the height of this node in the FORS or Merkle tree */
parameter SPX_OFFSET_TREE_INDEX = 18; /* The start of the 4 byte field used to specify the node in the FORS or Merkle tree */
