...
HD_PWD='C:/Users/phamkiet/Verilog/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log treehash_fors_gen_leaf_8_core_sha256_height_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source treehash_fors_gen_leaf_8_core_sha256_height_6.tcl
