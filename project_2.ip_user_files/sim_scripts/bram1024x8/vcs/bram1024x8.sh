...
#
# Script generated by Vivado on Mon Jun 03 21:41:03 +0700 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : bram1024x8.sh
...
#
# Usage        : bram1024x8.sh
#                bram1024x8.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram1024x8.sh [-reset_run]
#                bram1024x8.sh [-reset_log]
#                bram1024x8.sh [-help]
#
...
#                script (type 'bram1024x8.sh -help' for more information).
#
...
# script info
echo -e "bram1024x8.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram1024x8.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bram1024x8 xil_defaultlib.glbl -o bram1024x8_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bram1024x8_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bram1024x8_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bram1024x8_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram1024x8.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram1024x8.sh [-help]\n\
Usage: bram1024x8.sh [-step]\n\
Usage: bram1024x8.sh [-lib_map_path]\n\
Usage: bram1024x8.sh [-reset_run]\n\
Usage: bram1024x8.sh [-reset_log]\n\
Usage: bram1024x8.sh [-keep_index]\n\
Usage: bram1024x8.sh [-noclean_files]\n\n\
